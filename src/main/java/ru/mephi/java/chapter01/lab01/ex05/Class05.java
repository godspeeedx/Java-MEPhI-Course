...
public class Class05 {
    public static void main(String[] args) {
        ...
        double x = Integer.MAX_VALUE + 1.0;
        System.out.printf("Это значние, увеличенное на 1.0 типа double - %e, типа int - %d\n", x, (int)x);
        double y = Integer.MAX_VALUE + 7000000000.0;
        System.out.printf("Это значние, увеличенное на 7000000000.0 типа double - %e, типа int - %d\n", y, (int)y);
        System.out.println("\nЗадание выполнено!");
    }
}
